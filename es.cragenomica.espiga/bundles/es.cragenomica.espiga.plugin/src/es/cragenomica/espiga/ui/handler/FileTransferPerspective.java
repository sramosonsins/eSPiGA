...
public class FileTransferPerspective {
	@Execute
	public void execute(MApplication app, EPartService partService, 
		      EModelService modelService) {
		 MPerspective element = 
			        (MPerspective) modelService.find(UIConstants.ESPIGA_PERSPECTIVE_FTPTRANSFER, app);
	...
	public boolean canExecute(EModelService modelService,MWindow window) {
		...
		return !UIConstants.ESPIGA_PERSPECTIVE_FTPTRANSFER.equals(p.getElementId());
	}
